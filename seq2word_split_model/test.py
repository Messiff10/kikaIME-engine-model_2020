...
class InputEngineRnn:
    ...
    def __init__(self, graph_file, vocab_path, full_vocab, config_name, use_phrase=False):
...
if __name__ == "__main__":
    ...
    engine = InputEngineRnn(graph_file, vocab_path, full_vocab, config_name, use_phrase=False)
